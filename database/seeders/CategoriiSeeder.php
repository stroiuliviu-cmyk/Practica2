    ...
    public function run(): void
    {
        $categorii = [
            [
                ...
                'imagine' => 'img/placeholders/cat-cani.svg',
                'ordine_afisare' => 1,
                'activ' => true,
            ],
            [
                ...
                'imagine' => 'img/placeholders/cat-tricouri-maiouri.svg',
                'ordine_afisare' => 2,
                'activ' => true,
            ],
            [
                ...
                'imagine' => 'img/placeholders/cat-brelocuri.svg',
                'ordine_afisare' => 3,
                'activ' => true,
            ],
            [
                ...
                'imagine' => 'img/placeholders/cat-perne.svg',
                'ordine_afisare' => 4,
                'activ' => true,
            ],
            [
                ...
                'imagine' => 'img/placeholders/cat-puzzle.svg',
                'ordine_afisare' => 5,
                'activ' => true,
            ],
            [
                ...
                'imagine' => 'img/placeholders/cat-ceasuri.svg',
                'ordine_afisare' => 6,
                'activ' => true,
            ],
            [
                ...
                'imagine' => 'img/placeholders/cat-farfurii.svg',
                'ordine_afisare' => 7,
                'activ' => true,
            ],
            [
                ...
                'imagine' => 'img/placeholders/cat-tipar-fotografii.svg',
                'ordine_afisare' => 8,
                'activ' => true,
            ],
        ];
